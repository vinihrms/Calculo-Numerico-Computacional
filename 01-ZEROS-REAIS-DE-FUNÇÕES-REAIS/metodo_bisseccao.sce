...
deff('y = f(x)', 'y=x^3-9*x+3') // define a função f(x)
ak = 0.0                        // definição do limite inf. do intervalo
bk = 1.0                        // definição do limite sup. do intervalo

//***************************************************************************

episilon1 = 1e-06               // define precisao ou erro desejado para X
episilon2 = 1e-06               // define precisao ou erro desejado para Y
