...
c = [-1; -1; -1; -1; 0]; //diagonal superior (c1, c2, c3, c4)
b = [2; 2; 2; 2; 2]; //diagonal principal (b1, b2, b3, b4)
a = [0; -1; -1; -1; -1]; //diagonal inferior (a1, a2, a3, a4)
d = [100; 0; 0; 0; 200]; //vetor de termos independentes (d1, d2, d3, d4)
...
for i = 1:length(a)
    mprintf("%10.6f %10.6f %10.6f %10.6f\n", a(i), b(i), c(i), d(i))
end
